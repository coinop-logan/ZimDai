...
Given the scale of engagement we expect this paper to spark, we must assume we've revealed our hand to a potentially oppositional state. Having given up the element of surprise, moving quickly is important.

\subsection{Feedback and Partners} \label{feedback and partners}

In the coming weeks, we'll work to get this paper exposure, garnering as much feedback as possible. We'll focus around the subreddit \href{https://www.reddit.com/r/ZimDai}{r/ZimDai}, subreddits being a good engine for constructive dialogue with a dedicated community. As the ZimDai plan is improved in this process, we'll release successive versions of this paper.
